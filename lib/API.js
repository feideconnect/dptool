...
API.prototype.getPublic = function(method, endpoint, data) {
	var that = this;
	return new Promise(function(resolve, reject) {
...
API.prototype.get = function(method, endpoint, data, customtoken) {
	var that = this;
	return new Promise(function(resolve, reject) {
		var token = null;
		var tokenvalue;
...
API.prototype.getGKURL = function(id, path) {
	return 'https://' + id + '.dataporten-api.no' + path;
}
...
API.prototype.post = function(opts, omethod, data) {
